    ...
    public function run(): void
    {
        $layanan = [
            [
                ...
                'harga_satuan'  => 5000.00, // Harga per lembar
            ],
            [
            ...
            [
                ...
                'harga_satuan'  => 85000.00, // Harga jasa + kaos
            ],
            [
        ...
        foreach ($layanan as $item) {
            ...
            DB::table('jenis_layanans')->updateOrInsert(
                ...
                [
                    ...
                    'harga_satuan' => $item['harga_satuan'], // <--- HARGA_SATUAN SALAH
                    'created_at'  => now(),
                    'updated_at'  => now(),
                ]
            );
